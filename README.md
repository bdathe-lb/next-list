...
M0”项目骨架”、M1”账号与资料”、M2”小组与邀请”、M3”想法、表态与评论”、
M4”安排、随机与完成”和 M5”动态与通知”已经完成。M6”发布加固”正在进行中，
包含结构化可观测性、账号注销、Crashlytics、R8 混淆、无障碍加固与隐私政策入口；
本地全量验收通过。真实 Firebase 环境部署与预发布验证仍作为外部配置事项跟踪。
开发进度见 [PROGRESS.md](./PROGRESS.md)，产品和技术设计见
